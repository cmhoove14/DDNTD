...
This gives us our first key analytic finding, the identification of the breakpoint. If $R_{eff}<1$, `r latexImg("\\frac{dW}{dt}<0")` which implies that an $R_{eff}<1$ causes a worm population on the way to extinction (e.g. below the breakpoint)
