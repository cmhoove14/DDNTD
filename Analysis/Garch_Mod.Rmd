...
$$R_0=\frac{V\sigma\lambda\beta_E}{\gamma\delta}$$
...
$$\frac{dI}{dt}=\Big(\frac{\beta_EV\sigma\lambda I}{\rho}\Big)\Big(1-I\Big)-\gamma I $$

which can be translated to a discrete time model as: 
$$I_{t+1}=I_t+\Big(\frac{\beta_EV\sigma\lambda I}{\rho}\Big)\Big(1-I_t\Big)-\gamma I_t $$ 
...
$$I_{t+1}=I_t+\Big(\frac{\beta_EV\sigma\lambda IM(1-A_t)\mu}{\rho}\Big)\Big(1-I_t\Big)-I_t(\gamma+MA_t\theta) $$
